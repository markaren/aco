...
public class EntityListenerTests {
	...
	public void entityListenerPriority () {
		EntityListener a = Mockito.mock(EntityListener.class);
		EntityListener b = Mockito.mock(EntityListener.class);
		EntityListener c = Mockito.mock(EntityListener.class);
		InOrder inOrder = Mockito.inOrder(a, b, c);
    ...
    public void componentHandlingInListeners() {
        ...
        final ComponentRecorder recorder = Mockito.mock(ComponentRecorder.class);
