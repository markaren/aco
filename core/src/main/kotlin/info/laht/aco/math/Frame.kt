...
class Frame {
    ...
    fun setWorldNeedsUpdate() {
        ...
        children.forEach { obj: Frame -> obj.setWorldNeedsUpdate() }
    }
    ...
    fun getChildren(): List<Frame> {
        return children
    }

    var localTranslation: Vector3d
    ...
    override fun toString(): String {
        ...
        val DEGREE = "\u00b0"
        return "Frame{" + "translation=" + t + ", rotation=[x=" + Math.toDegrees(e.x) + DEGREE + ", y=" + Math.toDegrees(
            e.y
